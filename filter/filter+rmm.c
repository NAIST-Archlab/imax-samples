...
void tone_curve(int LANE, Uint *r, Uint *d, Uchar *t) /* R, D, lut */
{
#undef  NCHIP
#undef  RMGRP
#undef  OMAP
...
void hokan1(int LANE, Uint *c, Uint *p, struct SAD1 *s) /* W, R, SAD1 */
{
#undef  NCHIP
#undef  RMGRP
#undef  PAD
...
void hokan2(int LANE, struct SAD1 *s, Uint *minxy) /* [WD/4][8] */
{
#undef  NCHIP
#undef  RMGRP
#undef  PAD
...
void hokan3(int LANE, Uint *minxy, Uint *r, Uint *d)
{
#undef  NCHIP
#undef  RMGRP
#undef  PAD
...
void expand4k(int LANE, Uint *p, struct X *r)
{
#undef  NCHIP
#undef  RMGRP
#undef  PAD
...
void unsharp(int LANE, Uchar *p, Uchar *r)
{
#undef  NCHIP
#undef  RMGRP
#undef  OMAP
...
void blur(int LANE, Uint *p, Uint *r)
{
#undef  NCHIP
#undef  RMGRP
#undef  OMAP
...
void edge(int LANE, Uint *p, struct E *r)
{
#undef  NCHIP
#undef  RMGRP
#undef  OMAP
...
void bblur(int LANE, struct E *p, struct F *r)
{
  Ull  top, rofs, cofs, oc, pofs;
...
void wdifline(int LANE, Uint *l, Uint *r, struct SAD2 *d, int k)
{
#undef  NCHIP
#undef  RRANGE
#define NCHIP     1
#define RRANGE   ((HT-DWIN*2)/NCHIP)
  ...
  for (top=0; top<RRANGE; top++) { /* will be parallelized by multi-chip (M/#chip) */
    for (CHIP=0; CHIP<NCHIP; CHIP++) { /* will be parallelized by multi-chip (M/#chip) */
      volatile int idx = CHIP*RRANGE+DWIN+top;
      for (cofs=DWIN+k/2; cofs<WD-DWIN-k/2; cofs++) /* one scan-line */
	d->SAD2[idx][cofs] = 0;
    }
  }
