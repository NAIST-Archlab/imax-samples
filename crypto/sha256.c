...
void sha256_transform(int LANE, WORD thnum, SHA256_CTX *ctx, WORD *mbuf, WORD *state, WORD *sregs, BYTE *hash)
{
//DIV should be specified in Makefile* to share src for emax6/emax7.
//#define DIV  4 for 64unit
//#define DIV 16 for 16unit
